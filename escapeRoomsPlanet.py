...
# 성함 입력
driver.find_element(By.XPATH,'//*[@id="wrap"]/form/div[1]/article/section[1]/div/table/tbody/tr[3]/td/input').send_keys('이서라')
# 연락처 입력
driver.find_element(By.XPATH,'//*[@id="wrap"]/form/div[1]/article/section[1]/div/table/tbody/tr[4]/td/input').send_keys('010-8821-8986')
# 예약 인원 선택
